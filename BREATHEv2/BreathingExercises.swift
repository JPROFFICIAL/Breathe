...
class BreathingExercises {
    ...
    private var _inTime: NSTimeInterval!
    private var _outTime: NSTimeInterval!
    private var _holdTime: NSTimeInterval!
    ...
    var inTime: NSTimeInterval {
        return _inTime
    }
    
    var outTime: NSTimeInterval {
        return _outTime
    }
    
    var holdTime: NSTimeInterval {
        return _holdTime
    }
    ...
    var exercisesArray = [
        ...
        ["name": "Relaxing", "difficulty": "Beginner", "description": "You can perform the 'Relaxing' or '4-7-8' breath anywhere, but while learning sit in an upright position with your back straight. Breathe this atleast twice a day. DO NOT do more than four breaths at one time/cycle for the first month. ", "howTo": "Place the tip of your tounge against the tissue behind your front teeth and keep it there throughout the exercise. You will be exhaling from around your tongue. Close your mouth and inhale quietly through your nose for a count of FOUR. Once there, hold your breath for a count of SEVEN, then exhale with a 'Whooshing' sound through your mouth for a count of EIGHT. That is one Breath. Repeat THREE more times for a cycle of Four.", "inTime": "4.0", "outTime": "8.0", "holdTime": "7.0", "repeatNumber": "4"],
        ...
        ["name": "Alternate Nostril", "difficulty": "Intermediate", "description": "Calmness - balance. This is best done when you need to focus or energize yourself. Heads up - this can be a difficult exercise to do if you have a stuffy-nose.", "howTo": "In a comfortable/meditative position, hold your right thumb over the right nostril and breathe deeply through other. At the peak of inhalation, quickly close off the left nostril with your ring finger and exhale through the right. Continue the pattern by closing off left, inhaling through right, and exhaling out left.", "inTime": "4.0", "outTime": "4.0", "holdTime": "0", "repeatNumber": "8"],
        
        ["name": "Stimulating", "difficulty": "Advanced", "description": "The Stimulating Breath, also knows as the Bellows Breath - is aimed to increase alertness and raise energy levels. You should feel the effects on the back of your neck, chest and abdomen.", "howTo": "Inhale and exhale through your nose rapidly, keeping your mouth closed and relaxed. Try for 3 in and 3 out cycles per second. Your breaths in and out should be as short as possible, and equal in duration. DO NOT try for more than 15 counts on your first time, and ALWAYS remember to stop and adapt the exercise if you feel light headed or start to hyperventilate. With all of the exercises, once comfortable feel free to increase your time by five seconds or so.", "inTime": "1.0", "outTime": "0.0", "holdTime": "0", "repeatNumber": "10"],

        ["name": "Roll", "difficulty": "Advanced", "description": "Use the full capacity of your lungs and find the natural rhythm in your breath. An adapted version of the Abdominal Breathing technique.", "howTo": "This exercise is best learned lying on your back with your knees bent. Inhale through your nose - exhale through your mouth with your shoulders relaxed. Place your left hand on your abdomen and your right hand on your chest. Inhale first into your lower lungs, and then continue inhaling into your upper chest. Exhale slowly through your mouth, making a quiet whooshing sound as your left hand falls, then your right hand. Practice this exercise for 3 to 5 minutes. The motion in your diaphragm and chest is comparable to a wave. If beginning to become light headed or hyperventilate, slow your breathing and stand up slowly.", "inTime": "6.0", "outTime": "6.0", "holdTime": "0", "repeatNumber": "6"]
        
    ]
    
    
    init(name: String, difficulty: String, description: String, howTo: String, inTimer: NSTimeInterval, outTimer: NSTimeInterval, holdTimer: NSTimeInterval, repeatNumbers: Int) {
        _exerName = name
